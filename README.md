...
1. Estruturação do servidor Flask  
2. Modelagem do banco de dados com SQLAlchemy  
3. Criação do sistema de ranking  
4. Implementação do sistema de tempo e pontuação  
5. Integração entre backend e frontend  
6. Desenvolvimento do analisador de batidas com Librosa  
7. Testes de sincronização e balanceamento  
